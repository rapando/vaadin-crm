...
public class ContactService {
    ...
    public List<Contact> findAll(String stringFilter) {
        ...
        return contactRepository.search(stringFilter); // search method is added in the repository
    }
    public long count() {
    ...
    public void save(Contact contact) {
        if (contact == null) {
            LOGGER.log(Level.SEVERE, "contact is null, are you sure you are connected your form to the application?");
            return;
        }
